...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      "Sınırsız vaka — fair-use 10/gün AI değerlendirme",
      "Tüm dilekçe şablonları + AI üretimi",
      "AI Tutor sınırsız",
  ...
  {
    name: "Pro",
    description: "Yoğun çalışma + öncelikli AI + detaylı analiz.",
    price: "400",
    period: "ay",
    yearly: { price: "3.990", saving: "%17" },
    includes: "Core'daki her şey +",
    features: [
      "Günlük 20 AI vaka (Core'un 2 katı)",
      "Öncelikli AI yanıtları — kuyruksuz",
      "Detaylı performans analizi + haftalık rapor",
