...
/**
 * BetaGate — yalnızca admin (hard-coded email allow-list) erişimi var.
 *
 * Auth.loading sürerken küçük spinner gösterir.
 * Auth bitti ve user yoksa → "Giriş yap" daveti.
 * Auth bitti, user var, admin DEĞİL → "Bekleme listesi" mesajı.
 * Auth bitti, user var, ADMIN → içeriği render eder.
 */
      ...
      <section className="mx-auto flex max-w-2xl flex-col items-center px-6 py-20 text-center">
        ...
        <div className="mt-12 rounded-2xl border border-line bg-surface-raised p-5 text-left">
          ...
          <ul className="space-y-2 text-xs leading-relaxed text-ink-2">
            <li>• Vaka Studio — 6 derin demo vaka + AI Vaka Üretici</li>
            <li>• Dilekçe Lab — parça parça yazım + AI rubrik değerlendirme</li>
            <li>• HMGS Arena — tanı testi + AI soru üretimi</li>
